/*
 * Автоматическая регулировка яркости OLED через ESP8266
 * Версия 2.0 - Оптимизированная с сохранением калибровки
 * 
 * Компоненты:
 * - ESP8266 (NodeMCU, Wemos D1 Mini и т.д.)
 * - Фоторезистор
 * - Резистор 10кОм
 * 
 * Подключение:
 * - Фоторезистор: 3.3V --- [Фоторезистор] --- A0 --- [10kΩ] --- GND
 */
